...
class SendaiOpenDataService {
  ...
  addShichigahamaSpots() {
    const shichigahamaSpots = [
      ...
      {
        id: 'shichigahama_hanabuchi_lighthouse',
        name: '花淵灯台',
        lat: 38.3055,
        lon: 141.0615,
        address: '宮城郡七ヶ浜町花渕浜',
        description: '花淵浜に建つ白い灯台。松島湾の景色を一望できる人気の撮影スポットです。夕日の時間帯は特に美しい風景が楽しめます。',
        type: '観光スポット',
        url: '',
        source: '七ヶ浜町観光協会',
        types: ['lighthouse', 'tourist_attraction', 'natural_feature'],
        theme: '自然',
        rating: 4.3
      },
      {
        id: 'shichigahama_choyodai',
        name: '眺洋台',
        lat: 38.3030,
        lon: 141.0530,
        address: '宮城郡七ヶ浜町',
        description: '太平洋を一望できる展望台。晴れた日には遠く牡鹿半島まで見渡せます。朝日や夕日の絶景ポイントとして知られています。',
        type: '展望台',
        url: '',
        source: '七ヶ浜町観光協会',
        types: ['viewpoint', 'tourist_attraction', 'natural_feature'],
        theme: '自然',
        rating: 4.4
      },
      {
        id: 'shichigahama_seasaw',
        name: 'カフェレストラン SEASAW',
        lat: 38.2978,
        lon: 141.0652,
        address: '宮城郡七ヶ浜町菖蒲田浜長砂20-8',
        description: '菖蒲田浜海水浴場の目の前にあるログハウス風カフェレストラン。自家製「浜ののりだれ」を使った「のりカルボナーラ」が人気。地元食材を使った料理を楽しめます。',
        type: 'カフェレストラン',
      ...
      {
        id: 'shichigahama_hanabushi_shrine',
        name: '鼻節神社',
        lat: 38.3045,
        lon: 141.0610,
        address: '宮城郡七ヶ浜町花渕浜',
        description: '花渕浜の鎮守として古くから信仰を集める神社。松島湾を望む高台に鎮座し、境内からの眺めも素晴らしいです。',
        type: '神社',
        url: '',
        source: '七ヶ浜町',
      ...
      {
        id: 'shichigahama_learning_center',
        name: '七ヶ浜町生涯学習センター',
        lat: 38.3065,
        lon: 141.0560,
        address: '宮城郡七ヶ浜町境山2-1-12',
        description: '図書館、研修室、ホールなどを備えた生涯学習の拠点施設。地域の文化活動や学習活動の場として利用されています。',
        type: '文化施設',
        url: '',
        source: '七ヶ浜町',
      ...
      {
        id: 'shichigahama_paraglider',
        name: '松島熱気球パラグライダー体験',
        lat: 38.2985,
        lon: 141.0655,
        address: '宮城郡七ヶ浜町菖蒲田浜',
        description: '菖蒲田海岸から海の上を遊覧飛行するパラグライダー体験。松島の島々を背景に空を飛ぶ、東北最長約15分の飛行時間が楽しめます。',
        type: 'アクティビティ',
        url: '',
        source: '七ヶ浜町観光協会',
      ...
      {
        id: 'shichigahama_glass_tico',
        name: 'ガラスデザイン工房 tico',
        lat: 38.3010,
        lon: 141.0620,
        address: '宮城郡七ヶ浜町',
        description: 'サンドブラスト体験ができるガラス工房。オリジナルのグラスやアクセサリーを作ることができます。お土産にも最適です。',
        type: '体験施設',
        url: '',
        source: '七ヶ浜町観光協会',
        types: ['workshop', 'tourist_attraction'],
        theme: '文化',
        rating: 4.2
      },
      {
        id: 'shichigahama_uminoeki',
        name: 'うみの駅 七のや',
        lat: 38.2992,
        lon: 141.0628,
        address: '宮城郡七ヶ浜町',
        description: '七ヶ浜町の海産物や特産品を販売する道の駅。新鮮な魚介類や地元の加工品、お土産が揃います。海鮮丼などの食事も楽しめます。',
        type: 'グルメ・お土産',
        url: '',
        source: '七ヶ浜町',
        types: ['store', 'restaurant', 'tourist_attraction'],
        theme: 'グルメ',
        rating: 4.3
      },
      {
        id: 'shichigahama_shichi_resort',
        name: 'シチノリゾート',
        lat: 38.2995,
        lon: 141.0632,
        address: '宮城郡七ヶ浜町',
        description: '七ヶ浜町観光交流センターのある賑わいの場。飲食店や土産物店が集まり、地域の観光拠点となっています。',
        type: 'グルメ・ショッピング',
        url: '',
        source: '七ヶ浜町',
      ...
      {
        id: 'shichigahama_matsushima_overlook',
        name: '松島四大観「偉観」',
        lat: 38.3105,
        lon: 141.0505,
        address: '宮城郡七ヶ浜町代ヶ崎浜',
        description: '多聞山から望む松島湾の景色は、松島四大観の一つ「偉観」として知られています。260余りの島々が織りなす壮大な景観は圧巻です。',
        type: '展望スポット',
        url: '',
        source: '七ヶ浜町観光協会',
        types: ['viewpoint', 'tourist_attraction', 'natural_feature'],
      ...
      {
        id: 'shichigahama_beach_cycling',
        name: '七ヶ浜海岸サイクリングロード',
        lat: 38.2970,
        lon: 141.0640,
        address: '宮城郡七ヶ浜町',
        description: '海岸線に沿って整備されたサイクリングロード。美しい海の景色を眺めながら、爽やかな潮風を感じられます。レンタサイクルも利用可能です。',
        type: 'アクティビティ',
        url: '',
        source: '七ヶ浜町',
        types: ['cycling', 'activity', 'natural_feature'],
        theme: 'エンタメ',
        rating: 4.1
      },
      {
        id: 'shichigahama_tsunami_memorial',
        name: '七ヶ浜町震災復興メモリアルパーク',
        lat: 38.2960,
        lon: 141.0670,
        address: '宮城郡七ヶ浜町',
        description: '東日本大震災の記憶を後世に伝えるメモリアル施設。復興の歩みを学び、防災意識を高めることができます。',
        type: '記念施設',
        url: '',
        source: '七ヶ浜町',
        types: ['memorial', 'museum'],
        theme: '歴史',
        rating: 4.0
      }
    ];
